...
IntroAssistant.prototype.setup = function() {
	...
	this.controller.setupWidget("classic-list", {
		itemTemplate: "intro/list-item",
	    listTemplate: "intro/list",
		hasNoWidgets: true,
	}, {
		listTitle: "Classic",
		items: [
...
IntroAssistant.prototype.queryData = function(){
	this.db = openDatabase('COUNTDOWNPuzzles', '', 'User-Created Countdown Puzzles', 65536);
	var mytext = 'select * from favorites;'
    this.db.transaction( 
        (function (transaction) { 
...
IntroAssistant.prototype.queryDataHandler = function(transaction, results) { 
	var list = [];
